...
# -------------------------- ASCENSO DE MÁXIMA INCLINACIÓN CON BÚSQUEDA ÓPTIMA (UNIFICADO) -------------------
def ascenso_paso_optimo(x0, tol=1e-4, max_iter=200, mode="golden",
    ...
    - grid:    rejilla fina en [0, alpha_max] con n_grid puntos
    - golden:  búsqueda dorada en [0, alpha_max]
    - newton:  Newton-Raphson sobre phi(alpha), con 'newton_alpha0' y respaldo grid
    """
...
# -------- Probar búsqueda óptima (ahora usa la función unificada) ----------
...
tray_opt,  val_opt,  alphas = ascenso_paso_optimo(x0, tol=tol, max_iter=max_iter,
                                                  mode="golden", alpha_max=1.0, n_grid=200, newton_alpha0=0.1)
...
# 3) BUSQUEDA ÓPTIMA (elige uno o None)
